...
resource "azapi_resource" "azure_local_virtual_machine" {
  ...
  # Keep these versions fixed so Vault credential rotation does not update or replace the VM.
  sensitive_body_version = {
    "properties.osProfile.adminUsername" = "initial"
    "properties.osProfile.adminPassword" = "initial"
  }
}
